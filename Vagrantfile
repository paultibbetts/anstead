...
ANSIBLE_PATH_ON_VM = '/home/vagrant/ansible' # absolute path to Ansible directory on virtual machine
...
aliasesPath = ANSIBLE_PATH + "/aliases"
...
Vagrant.configure('2') do |config|
  ...
  if Vagrant::Util::Platform.windows? and !Vagrant.has_plugin? 'vagrant-winnfsd'
    trellis_config.laravel_apps.each_pair do |name, site|
